...
df_final.to_csv("age0_visits_with_vaccination_status.csv", index=False)
print("✅ CSV saved as 'age0_visits_with_vaccination_status.csv'")
...
plt.title("Vaccinated vs Not Vaccinated Visits (Patients Aged 0)")
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig("vaccinated_vs_not_vaccinated_fixed_per_doctor.png")

print("✅ Graph saved as 'vaccinated_vs_not_vaccinated_fixed_per_doctor.png'")
